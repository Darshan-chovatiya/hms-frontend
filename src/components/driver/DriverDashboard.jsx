...
const DriverDashboard = ({setCurrentPage,toggleSidebar}) => {
  ...
  return (
    <div className="container-fluid p-0">
      <DriverHeader title="Dashboard" company={CompanyInfo} toggleSidebar={toggleSidebar} setCurrentPage={setCurrentPage} />
