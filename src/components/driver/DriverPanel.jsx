...
const DriverPanel = () => {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'Dashboard':
        return <DriverDashboard setCurrentPage={setCurrentPage} toggleSidebar={toggleSidebar} />;
      case 'Drivers':
        return <Drivers setCurrentPage={setCurrentPage} toggleSidebar={toggleSidebar} isOpen={isOpen}/>;
