  ...
  return (
    ...
    <div>
      <div className="d-flex justify-content-end align-items-center mb-3">
        <button className="btn btn-primary" onClick={() => setShowAddModal(true)}> + Add Hotels</button>
      </div>
      ...
      <div className="mb-3 d-flex align-items-center justify-content-between">
        ...
        <div>
          <input type="text" className="form-control" placeholder="Search Hotels..." value={search} onChange={(e) => setSearch(e.target.value)}/>
        </div>
      </div>
              ...
              <tr className="table-header">
                ...
                <th scope="col" className="border-0 py-4 px-xxl-2" style={{minWidth:"150px"}}>
                  <div className="d-flex align-items-center">
                    <span className="fw-bold text-dark">Hotels Name</span>
                  </div>
                </th>
                ...
                <tr>
                  <td colSpan="10" className="text-center py-5 border-0">
                    <div className="no-data-container" style={{ padding: '40px 20px', color: '#6c757d', backgroundColor: '#f8f9fa', borderRadius: '12px', margin: '20px', }} >
                      ...
                      <h5 style={{ marginBottom: '8px', color: '#495057' }}>No hotels found</h5>
    ...
    <div className="modal-dialog modal-dialog-centered">
      <form className="modal-content shadow rounded-4 overflow-hidden" onSubmit={handleUpdateSubmit}>
        <div className="modal-header bg-primary text-white">
          <h5 className="modal-title fw-semibold">Edit Hotel</h5>
    ...
    <div className="modal-dialog modal-lg modal-dialog-centered">
      <div className="modal-content border-0 shadow-lg rounded-4">
        <div className="modal-header bg-primary text-white rounded-top-4 px-4 py-3">
          <h5 className="modal-title fw-bold">Add Hotel</h5>
